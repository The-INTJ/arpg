...
public static partial class Scenes
{
	...
	private const string CombatRoot = Root + "combat/";
	private const string PickupRoot = Root + "pickups/";
	...
	public const string BridgePoint = PropRoot + "BridgePoint.tscn";
	...
	public const string IslandTunnelSlice = WorldSliceRoot + "IslandTunnelSlice.tscn";
	...
	public const string RunHistorySnippet = UiRoot + "RunHistorySnippet.tscn";
	public const string BackpackItemRow = UiComponentRoot + "BackpackItemRow.tscn";
	public const string RunHistoryCard = UiComponentRoot + "RunHistoryCard.tscn";
